...
namespace BlogCMS.Core.Migrations
{
    ...
    [Migration("20181019123821_SettingUpdate")]
            ...
            modelBuilder.Entity("BlogCMS.Entites.Conrete.Authorization", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CreatedAt = new DateTime(2018, 10, 19, 15, 38, 20, 862, DateTimeKind.Local), Name = "SuperAdmin", UpdatedAt = new DateTime(2018, 10, 19, 15, 38, 20, 862, DateTimeKind.Local) },
                        new { Id = 2, CreatedAt = new DateTime(2018, 10, 19, 15, 38, 20, 862, DateTimeKind.Local), Name = "Admin", UpdatedAt = new DateTime(2018, 10, 19, 15, 38, 20, 862, DateTimeKind.Local) },
                        new { Id = 3, CreatedAt = new DateTime(2018, 10, 19, 15, 38, 20, 862, DateTimeKind.Local), Name = "Author", UpdatedAt = new DateTime(2018, 10, 19, 15, 38, 20, 862, DateTimeKind.Local) }
                    );
                });
            ...
            modelBuilder.Entity("BlogCMS.Entites.Conrete.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AuthorizationId = 1, CreatedAt = new DateTime(2018, 10, 19, 15, 38, 20, 862, DateTimeKind.Local), Email = "sitahmetemin@gmail.com", Name = "Ahmet Emin ŞİT", Password = "123654", UpdatedAt = new DateTime(2018, 10, 19, 15, 38, 20, 862, DateTimeKind.Local) }
                    );
                });
